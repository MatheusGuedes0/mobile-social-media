...
class AtividadeService : Service(), SensorEventListener {
    ...
    // Use CoroutineScope para chamadas assíncronas
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        } ?: stopSelf() // Para se não tiver acelerômetro
    ...
    // Variáveis para cálculo simplificado do nível de atividade
    ...
    override fun onSensorChanged(event: SensorEvent?) {
        event?.let {
            if (it.sensor.type == Sensor.TYPE_ACCELEROMETER) {
                ...
                // Calcular a magnitude da aceleração (sem gravidade filtrada para simplificar)
                ...
                // Enviar dados a cada 5 minutos (300000 ms)
                if (currentTime - lastTimestamp > 300000) {
